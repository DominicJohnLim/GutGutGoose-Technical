...
Performance was summarized by species-recovery (precision/recall) and abundance rank
correlation (Spearman). Because MetaPhlAn profiling is deterministic, identical inputs
